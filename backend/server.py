...
# ========== PREDEFINED LEAGUES ==========
SUPPORTED_LEAGUES = [
    # British Isles (2024-25 season = 2024 in API Football)
    ...
    # European Leagues (2024-25 season = 2024 in API Football)
    ...
    # European Competitions (2024-25 season = 2024 in API Football)
