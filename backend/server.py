...
async def seed_fa_cup_manual():
    ...
    try:
        ...
        fa_cup_fixtures = [
            ...
            {"fixture_id": 9000011, "home_team": "Salford City", "away_team": "Swindon Town", "utc_date": datetime(2026, 1, 10, 15, 0), "league_id": 45, "league_name": "FA Cup", "matchday": "Third Round", "status": "FINISHED", "home_score": 1, "away_score": 0, "penalty_winner": None, "home_logo": "", "away_logo": ""},
