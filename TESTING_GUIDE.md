...
1. Go to: https://leaguepicks-1.preview.emergentagent.com
...
curl -X POST https://leaguepicks-1.preview.emergentagent.com/api/admin/update-results

# Refresh fixtures from API
curl -X POST https://leaguepicks-1.preview.emergentagent.com/api/admin/refresh-fixtures

# Score all pending predictions
curl -X POST https://leaguepicks-1.preview.emergentagent.com/api/admin/score-predictions

# Check leagues
curl https://leaguepicks-1.preview.emergentagent.com/api/leagues
```
...
curl -X POST https://leaguepicks-1.preview.emergentagent.com/api/promo-codes/validate \
  -H "Content-Type: application/json" \
  -d '{"code": "LAUNCH2024", "user_email": "your@email.com"}'

# Check promo stats
curl https://leaguepicks-1.preview.emergentagent.com/api/promo-codes/stats/LAUNCH2024
```
