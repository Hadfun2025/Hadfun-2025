          ...
          <TabsContent value="members">
            <Card>
              ...
              <CardContent className="space-y-6">
                {/* Enhanced Join Code Sharing - Option 1 (EASIEST) */}
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-300 rounded-lg p-5">
                  <h3 className="font-bold text-purple-900 mb-3 flex items-center gap-2 text-lg">
                    🎯 Quick Invite - Share Anywhere!
                  </h3>
                  <p className="text-sm text-gray-700 mb-4">
                    Share this code via WhatsApp, SMS, or any messaging app. No email needed!
                  </p>
                  
                  {/* Big Join Code Display */}
                  <div className="bg-white border-2 border-dashed border-purple-400 rounded-lg p-4 mb-4 text-center">
                    <Label className="text-sm text-gray-600 block mb-2">Team Join Code:</Label>
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      {sentInvitations.map((invitation) => (
                        <div key={invitation.id} className="bg-white p-3 rounded border border-amber-100 flex justify-between items-center">
                          <div>
                            <span className="font-medium text-gray-900">{invitation.invited_username}</span>
                    ...
                    <p className="text-xs text-gray-600 mt-3">
                      💡 Tip: Pending invitations appear when the user logs in to the app
                    </p>
                  </div>
                )}
